...
lblCurrencyConverter.setForeground(new Color(0, 0, 128));
lblCurrencyConverter.setFont(new Font("Rockwell Condensed", Font.BOLD, 18));
lblCurrencyConverter.setBounds(127, 11, 271, 32);
...
comboBox.setForeground(new Color(255, 20, 147));
...
comboBox_1.setForeground(new Color(255, 20, 147));
...
btnCovert.setForeground(new Color(153, 50, 204));
...
btnCovert.setBounds(243, 304, 89, 40);
frame.getContentPane().add(btnCovert);
JButton btnClear = new JButton("Clear");
btnClear.setFont(new Font("Tahoma", Font.BOLD, 11));
btnClear.setForeground(new Color(34, 139, 34));
...
btnClear.setBounds(256, 375, 66, 40);
