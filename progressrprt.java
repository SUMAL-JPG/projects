...
public void run() {
try {
progressrprt window = new progressrprt();
...
frame.setTitle("              ");
frame.setBackground(new Color(250, 128, 114));
...
lblCourseCode.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblAverage.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblRanking.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblBiology.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblComputer.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblChemistry.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblPhysics.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblTamil.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
lblMalayalam.setFont(new Font("Times New Roman", Font.BOLD, 20));
...
btnAddResult.setForeground(new Color(0, 0, 205));
